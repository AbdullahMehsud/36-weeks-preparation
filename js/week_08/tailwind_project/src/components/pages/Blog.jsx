...
function Blog() {
  ...
  return (
    <>
      <div className="grid md:grid-cols-3 grid-cols-1 md:px-20 px-2 md:gap-6 gap-2 mt-20 mb-20">
        {blogs.map((blog, index) => (
          <div key={index} className="py-5">
            <img
              src={blog.image}
              alt=""
              className="w-96 rounded-3xl hover:opacity-70 cursor-pointer duration-500"
            />
